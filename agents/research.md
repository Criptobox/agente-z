...
3. **Formula la causa raíz** en una frase. Si no puedes en una frase, no la tienes.
4. **Propón UN diagnóstico** y un siguiente paso concreto para `code`.
5. **Si encuentras un bug de librería conocido**, citar la URL del issue de GitHub o StackOverflow.
